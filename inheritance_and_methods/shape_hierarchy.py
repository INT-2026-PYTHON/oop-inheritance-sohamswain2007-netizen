...
class Shape:
    ...
    def area(self):
        raise NotImplementedError("Child classes must override area()")

    def perimeter(self):
        raise NotImplementedError("Child classes must override perimeter()")
...
if __name__ == "__main__":
    try:
        ...
        print("Shape itself raises NotImplementedError when describe() is called.")
